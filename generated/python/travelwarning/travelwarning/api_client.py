...
from travelwarning import rest
from travelwarning.configuration import Configuration
from travelwarning.exceptions import ApiTypeError, ApiValueError, ApiException
from travelwarning.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_healthcare  # this is an instance of the class Endpoint
        api_instance.get_healthcare()  # this invokes api_instance.get_healthcare.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_healthcare.callable or self.callable in this class
